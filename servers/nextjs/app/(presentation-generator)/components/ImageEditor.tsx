...
const ImageEditor = ({
  ...
  const getPreviousGeneratedImage = async () => {
    try {
      ...
      toast.error("Lỗi khi lấy hình ảnh đã tạo trước đó. Vui lòng thử lại.");
      console.error("lỗi khi lấy hình ảnh đã tạo trước đó", error);
      setError(
        error.message ||
          "Lỗi khi lấy hình ảnh đã tạo trước đó. Vui lòng thử lại."
      );
    }
  };
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      console.error("Lỗi tạo hình ảnh", err);
      setError(err.message || "Lỗi tạo hình ảnh. Vui lòng thử lại.");
    } finally {
  ...
  const handleFileUpload = async (
    ...
    if (file.size > 5 * 1024 * 1024) {
      setUploadError("Kích thước file phải nhỏ hơn 5MB");
      return;
    }

    // Validate file type
    if (!file.type.startsWith("image/")) {
      setUploadError("Vui lòng tải lên file hình ảnh");
      return;
    }
    ...
    try {
      ...
      setUploadError("Lỗi khi tải lên hình ảnh. Vui lòng thử lại.");
  ...
  return (
    <div className="image-editor-container">
      <Sheet open={isOpen} onOpenChange={() => handleClose()}>
        ...
        >
          <SheetHeader>
            <SheetTitle>Cập nhật hình ảnh</SheetTitle>
          </SheetHeader>
          ...
          <div className="mt-6">
            <Tabs defaultValue="generate" className="w-full">
              ...
              <TabsContent
                value="generate"
                className="mt-4 space-y-4 overflow-y-auto hide-scrollbar h-[85vh]"
              >
