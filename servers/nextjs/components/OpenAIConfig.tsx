    ...
    <div className="space-y-6">
      ...
      <div className="mb-4">
        ...
        <p className="mt-2 text-sm text-gray-500 flex items-center gap-2">
          ...
          API key của bạn sẽ được lưu trữ cục bộ và không bao giờ bị chia sẻ
        </p>
      </div>
      ...
      {modelsChecked && availableModels.length === 0 && (
        <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            Không tìm thấy model. Vui lòng đảm bảo API key của bạn hợp lệ và có
            quyền truy cập vào model OpenAI.
          </p>
        </div>
      )}
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-gray-500 flex items-center gap-2">
          <span className="block w-1 h-1 rounded-full bg-gray-400"></span>
          Nếu được bật, model có thể sử dụng tìm kiếm web khi có sẵn.
        </p>
      </div>
    </div>
  );
